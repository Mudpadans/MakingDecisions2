...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24,28,32];
// Do not edit the code above.
...
/*if (myFavoriteNumbers.length < 7) {
  ...
  someNum = myFavoriteNumbers.splice(6, 1);
  console.log('There are more than enough elements in this array');
  console.log(someNum);
} else if (myFavoriteNumbers.length === 7) {
  someNum = myFavoriteNumbers.pop(); 
  console.log('There are just enough elements in this array');
  console.log(someNum);
}
*/
////////// PROBLEM 8 //////////
